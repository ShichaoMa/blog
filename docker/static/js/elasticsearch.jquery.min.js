    ...
    !function (a) {
        ...
        (function (a) {
            !function (b) {
                ...
                a.jquery_build = !0;
                var e = c(2);
                b.es = b.extend({}, e), b.es.Client = function (a) {
                    return a = a || {}, a.defer = d, a.$ = b, new e.Client(a)
                }
            }(jQuery)
        }).call(b, c(1))
    }, function (a, b) {
        ...
        d.Client = c(3), d.ConnectionPool = c(34), d.Transport = c(4), d.errors = c(18), a.exports = d
    }, function (a, b, c) {
        function d(a) {
            function b() {
        ...
        (function (b) {
            function d(a) {
                var b = this;
                a = b._config = a || {};
                var f = "function" == typeof a.log ? a.log : c(29);
                a.log = b.log = new f(a);
                ...
                a.hasOwnProperty("sniffedNodesProtocol") ? b.sniffedNodesProtocol = a.sniffedNodesProtocol || null : b.sniffedNodesProtocol = i(b.connectionPool.getAllHosts()) || null, a.sniffOnStart && b.sniff(), a.sniffInterval && b._timeout(function c() {
                    b.sniff(), b._timeout(c, a.sniffInterval)
                }, a.sniffInterval), a.sniffOnConnectionFault && h(b)
            }

            a.exports = d;
            var e = c(5), f = c(18), g = c(19), h = c(26), i = c(27);
            d.connectionPools = {main: c(34)}, d.serializers = c(43), d.nodesToHostCallbacks = {main: c(46)}, d.prototype.defer = function () {
                ...
                var j, k, l, m, n, o = this, p = this.maxRetries, q = this.requestTimeout, r = !1, s = a.body, t = a.headers ? e.transform(a.headers, function (a, b, c) {
                ...
                a = "function" == typeof a ? a : e.noop, this.request({
                    ...
                    query: {filter_path: ["nodes.*.http.publish_address", "nodes.*.name", "nodes.*.hostname", "nodes.*.host", "nodes.*.version"].join(",")},
                    method: "GET"
                }, function (g, h, i) {
                    if (!g && h && h.nodes) {
                        var j;
                        try {
                            ...
                            return void d.error(new Error("Unable to convert node list from " + this.sniffEndpoint + " to hosts durring sniff. Encountered error:\n" + (a.stack || a.message)))
                        }
        ...
        (function (b, d) {
            ...
            var f = c(10), g = c(11), h = c(14), i = h.assign({}, h, g);
            i.joinPath = f.join, i.get = c(16), i.trimEnd = c(17), i.deepMerge = function (a, b) {
        ...
        function e(a) {
            var b, d, e, f, g, h, i = a.length;
            g = c(a), h = new k(3 * i / 4 - g), e = g > 0 ? i - 4 : i;
            var l = 0;
            for (b = 0, d = 0; b < e; b += 4, d += 3)f = j[a.charCodeAt(b)] << 18 | j[a.charCodeAt(b + 1)] << 12 | j[a.charCodeAt(b + 2)] << 6 | j[a.charCodeAt(b + 3)], h[l++] = f >> 16 & 255, h[l++] = f >> 8 & 255, h[l++] = 255 & f;
            return 2 === g ? (f = j[a.charCodeAt(b)] << 2 | j[a.charCodeAt(b + 1)] >> 4, h[l++] = 255 & f) : 1 === g && (f = j[a.charCodeAt(b)] << 10 | j[a.charCodeAt(b + 1)] << 4 | j[a.charCodeAt(b + 2)] >> 2, h[l++] = f >> 8 & 255, h[l++] = 255 & f), h
        }
        ...
        (function (a, d) {
            ...
            b.debuglog = function (a) {
                ...
                date: "magenta",
                regexp: "red"
            }, b.isArray = o, b.isBoolean = p, b.isNull = q, b.isNullOrUndefined = r, b.isNumber = s, b.isString = t, b.isSymbol = u, b.isUndefined = v, b.isRegExp = w, b.isObject = x, b.isDate = y, b.isError = z, b.isFunction = A, b.isPrimitive = B, b.isBuffer = c(12);
            var J = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];
            b.log = function () {
                console.log("%s - %s", E(), b.format.apply(b, arguments))
            }, b.inherits = c(13), b._extend = function (a, b) {
                if (!b || !x(b))return a;
            ...
            (function () {
                ...
                function t(a) {
                    ...
                    function w(a) {
                        ...
                        var c = a[0], d = a[1], e = a[2], f = a[3], g = a[4], i = a[5], j = 1 & d, k = 2 & d, l = 4 & d, m = 8 & d, n = c;
                        return jd(b, a), b
                    }
                    ...
                    function ka(a, b, c) {
                        var d = -1, e = pa(), h = a ? a.length : 0, i = [], j = !b && h >= A && e === f, k = c || j ? n() : i;
                        if (j) {
                            var m = l(k);
                            e = g, k = m
                        }
                    ...
                    function Za(a) {
                        var b = arguments, c = -1, d = ea(b, !0, !1, 1), e = b[2] && b[2][b[1]] === a ? 1 : d.length, f = uc(e);
                    ...
                    function fb(a, b) {
                        var c = s(arguments, 2), d = -1, e = "function" == typeof b, f = a ? a.length : 0, g = uc("number" == typeof f ? f : 0);
                    ...
                    function lc(a, c, d) {
                        ...
                        a = Dc(a || ""), d = wd({}, d, e);
                        var f, g = wd({}, d.imports, e.imports), h = md(g), i = Ya(g), j = 0, k = d.interpolate || L, l = "__p += '", n = Cc((d.escape || L).source + "|" + k.source + "|" + (k === J ? G : L).source + "|" + (d.evaluate || L).source + "|$", "g");
                    ...
                    gd[S] = gd[U] = gd[X] = {
                        ...
                        toString: !0,
                        valueOf: !0
                    }, gd[V] = gd[W] = gd[Z] = {constructor: !0, toString: !0}, gd[Y] = {constructor: !0}, function () {
                ...
                var aa = {leading: !1, maxWait: 0, trailing: !1}, ba = {
                    ...
                    "\u2028": "u2028",
                    "\u2029": "u2029"
                }, fa = da[typeof window] && window || this, ga = da[typeof b] && b && !b.nodeType && b, ha = da[typeof a] && a && !a.nodeType && a, ia = (ha && ha.exports === ga && ga, da[typeof e] && e);
        ...
        (function (b) {
            ...
            }(), ja = fa.toString, ka = ga.hasOwnProperty, la = ga.toString, ma = RegExp("^" + ja.call(ka).replace($, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), na = da.Symbol, oa = ea.splice, pa = C(da, "Map"), qa = C(Object, "create"), ra = na ? na.prototype : void 0, sa = ra ? ra.toString : void 0;
        ...
        var f = c(5), g = a.exports, h = "function" == typeof Error.captureStackTrace, i = !!(new Error).stack;
        ...
        (function (b) {
            ...
            a.exports = d;
            var f, g = c(20), h = c(23), i = c(5), j = /^([a-z]+:)?\/\//, k = "http:";
        ...
        d.prototype.parse = function (a, b, c) {
            ...
            var r = c.pathname && "/" === c.pathname.charAt(0), s = a.host || a.pathname && "/" === a.pathname.charAt(0), t = s || r || c.host && a.pathname, u = t, v = c.pathname && c.pathname.split("/") || [], o = a.pathname && a.pathname.split("/") || [], y = c.protocol && !x[c.protocol];
        ...
        (function (a, e) {
            !function (f) {
                ...
                var t, u = 2147483647, v = 36, w = 1, x = 26, y = 38, z = 700, A = 72, B = 128, C = "-", D = /^xn--/, E = /[^\x20-\x7E]/, F = /[\x2E\u3002\uFF0E\uFF61]/g, G = {
        ...
        "use strict";
        b.decode = b.parse = c(24), b.encode = b.stringify = c(25)
    }, function (a, b) {
        "use strict";
        function c(a, b) {
            return Object.prototype.hasOwnProperty.call(a, b)
        ...
        (function (b) {
            ...
            var e = c(5), f = c(20), g = c(30).EventEmitter;
            e.inherits(d, g), d.loggers = c(31), d.prototype.close = function () {
        ...
        (function (b) {
            ...
            a.exports = d;
            var e = c(5), f = c(29);
            d.selectors = c(35), d.defaultSelector = "roundRobin", d.connectionClasses = c(38), d.defaultConnectionClass = d.connectionClasses._default, delete d.connectionClasses._default, d.calcDeadTimeoutOptions = {
                flat: function (a, b) {
                    return b
        ...
        a.exports = {random: c(36), roundRobin: c(37)}
    }, function (a, b) {
        a.exports = function (a) {
        ...
        var d = {xhr: c(39), jquery: c(40), angular: c(42)}, e = c(5);
        ...
        a.exports = d;
        var e = c(5), f = c(41), g = c(18).ConnectionFault;
        e.inherits(d, f), d.prototype.request = function (a, b) {
            var c = {
                url: this.host.makeUrl(a),
                data: a.body,
                type: a.method,
                dataType: "text",
                headers: this.host.getHeaders(a.headers),
                done: b
            }, d = jQuery.ajax(c).done(function (a) {
        ...
        a.exports = d;
        var e = c(5), f = c(30).EventEmitter, g = c(29), h = c(19), i = c(18);
        ...
        a.exports = {angular: c(44), json: c(45)}
    }, function (a, b, c) {
        function d() {
        }
            ...
            return function (b) {
                return e.transform(b, function (b, c, d) {
                    ...
                    if (g) {
                        ...
                        }, i = new Error("Malformed " + a + ". Got " + JSON.stringify(g) + ' and expected it to match "{hostname?}/{ip}:{port}".'), j = f.exec(g);
        ...
        var d = c(47).makeFactoryWithModifier(function (a) {
            return c(5).merge(a, {params: {filterPath: {type: "list", name: "filter_path"}}})
        }), e = c(47).namespaceFactory, f = a.exports = {};
        ...
        f._namespaces = ["cat", "cluster", "indices", "ingest", "nodes", "snapshot", "tasks"], f.bulk = d({
            ...
            urls: [{
                fmt: "/_search/scroll/<%=scrollId%>",
                req: {scrollId: {type: "list"}}
            }, {fmt: "/_search/scroll"}], paramAsBody: "scrollId", method: "DELETE"
        }), f.cluster = e(), f.cluster.prototype.allocationExplain = d({
            params: {
                includeYesDecisions: {
                    type: "boolean",
            ...
            params: {
                ...
                version: {type: "number"},
                versionType: {
                    type: "enum", options: ["internal", "external", "external_gte", "force"], name: "version_type"
                }
            },
            url: {
                fmt: "/<%=index%>/<%=type%>/<%=id%>",
            ...
            params: {
                ...
                waitForCompletion: {type: "boolean", name: "wait_for_completion"},
                groupBy: {
                    type: "enum", default: "nodes", options: ["nodes", "parents"], name: "group_by"
                }
            }, url: {fmt: "/_tasks"}
        }),f.termvectors = d({
            params: {
        ...
        f._namespaces = ["cat", "cluster", "indices", "nodes", "snapshot", "tasks"], f.bulk = d({
            params: {
                consistency: {
                    type: "enum",
        ...
        }), f.cluster = e(), f.cluster.prototype.getSettings = d({
            params: {
                flatSettings: {
                    type: "boolean",
                    name: "flat_settings"
        ...
        }), f.indices.prototype.deleteWarmer = d({
            params: {
                masterTimeout: {type: "time", name: "master_timeout"},
                name: {type: "list"}
            },
        ...
        }), f.indices.prototype.getAliases = d({
            ...
            urls: [{
                ...
                fmt: "/<%=index%>/_mapping/field/<%=fields%>",
                req: {index: {type: "list"}, fields: {type: "list"}}
            }, {fmt: "/_mapping/<%=type%>/field/<%=fields%>", req: {type: {type: "list"}, fields: {type: "list"}}}, {
                fmt: "/_mapping/field/<%=fields%>",
                req: {fields: {type: "list"}}
            }]
        }), f.indices.prototype.getMapping = d({
            params: {
                ignoreUnavailable: {
        ...
        }), f.indices.prototype.getWarmer = d({
            params: {
                ignoreUnavailable: {
                    type: "boolean",
                    name: "ignore_unavailable"
        ...
        }), f.indices.prototype.optimize = d({
            params: {
                flush: {type: "boolean"},
                ignoreUnavailable: {type: "boolean", name: "ignore_unavailable"},
                allowNoIndices: {type: "boolean", name: "allow_no_indices"},
        ...
        }), f.indices.prototype.putWarmer = d({
            params: {
                masterTimeout: {type: "time", name: "master_timeout"},
                ignoreUnavailable: {type: "boolean", name: "ignore_unavailable"},
                allowNoIndices: {type: "boolean", name: "allow_no_indices"},
            ...
            params: {
                ...
                routing: {type: "string"},
                script: {type: "string"},
                scriptId: {type: "string", name: "script_id"},
        ...
        f._namespaces = ["cat", "cluster", "indices", "ingest", "nodes", "remote", "snapshot", "tasks"], f.bulk = d({
            ...
            params: {
                ...
                fmt: "/<%=index%>/_mapping/<%=type%>/field/<%=fields%>", req: {
                    index: {type: "list"}, type: {type: "list"}, fields: {
                        type: "list"
                    }
                }
            }, {
